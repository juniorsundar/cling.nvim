...
describe("core", function()
    ...
    it("BufWipeout on cling buffer clears the window handle", function()
        core.executor("echo hello", "/tmp")
    ...
    it("q keymap closes the cling window and clears handles", function()
        core.executor("echo hello", "/tmp")
    ...
    it("close_cling_window clears handles and deletes the buffer", function()
        core.executor("echo hello", "/tmp")
